...
- User-facing Full Disk Access recovery copy must be localized through `src/i18n/locales/*` and covered by `npm run lint:i18n`; do not hardcode one locale inside shared permission hooks.
